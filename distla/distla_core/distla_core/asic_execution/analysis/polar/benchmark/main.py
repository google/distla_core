...
from distla_core.analysis.benchmarks import benchmark_polar
...
if __name__ == "__main__":
  ...
  P_SZS = (256, 8192)  # panel size of the SUMMA multiplications
  PRECISIONS = (lax.Precision.DEFAULT, lax.Precision.HIGHEST,
  ...
  S_MIN = (1E-4, 0.1) # Smallest nonzero singular value of the input matrix.
  ...
  _ = benchmark_polar.benchmark_polar(
