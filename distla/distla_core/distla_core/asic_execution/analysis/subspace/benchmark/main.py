...
from distla_core.analysis.benchmarks import benchmark_subspace
...
if __name__ == "__main__":
  ...
  P_SZS = (128, 256, 16384)  # panel size of the SUMMA multiplications
  ...
  _ = benchmark_subspace.benchmark_subspace(
